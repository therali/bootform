...
class BootForm
{
    ...
    {
        return isset($this->type) ? $this->type : $this->config->get('boot_form.type');
    }
    ...
    {
        return $this->leftColumnClass ?: $this->config->get('boot_form.left_column_class');
    }
    ...
    {
        return $this->leftColumnOffsetClass ?: $this->config->get('boot_form.left_column_offset_class');
    }
    ...
    {
        return $this->rightColumnClass ?: $this->config->get('boot_form.right_column_class');
    }
    ...
    {
        return $this->iconPrefix ?: $this->config->get('boot_form.icon_prefix');
    }
    ...
    {
        return $this->errorClass ?: $this->config->get('boot_form.error_class');
    }
    ...
    {
        return $this->errorBag ?: $this->config->get('boot_form.error_bag');
    }
    ...
    protected function getFieldError($field, $format = '<span class="help-block">:message</span>')
    {
        ...
        if ($this->getErrors()) {
            $allErrors = $this->config->get('boot_form.show_all_errors');
